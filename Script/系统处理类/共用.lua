...
-- @Last Modified time: 2020-11-14 22:04:11
--======================================================================--
...
function 取物品(wd)
  ...
  elseif wd == "一倍经验丹" then
    wds[1] = "基础经验额外增加1倍,可以与双倍、精修、双倍经验丹同时存在,每次使用获得1小时有效时间。无法冻结、无法叠加使用。"
    wds[2] = 4
    wds[3] = 2
    wds[4] = 0
      wds[11] = "item.wd1"
